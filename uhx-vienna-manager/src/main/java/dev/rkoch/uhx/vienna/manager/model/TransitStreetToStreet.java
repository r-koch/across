...
public enum TransitStreetToStreet {
  ...
  private TransitStreetToStreet() {
    intent = Intent.builder() //
        .withName(CustomIntent.TRANSIT_STREET_TO_STREET) //
  ...
  private List<String> getSamples() {
    return List.of(ModelUtil.sampleOf(CustomSlotName.FROM, CustomSlotName.STREET_NAME_FROM,
        CustomSlotName.HOUSE_NUMBER_FROM, CustomSlotName.TO, CustomSlotName.STREET_NAME_TO,
        CustomSlotName.HOUSE_NUMBER_TO));
  }
